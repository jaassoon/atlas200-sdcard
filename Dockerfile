...
WORKDIR /opt
RUN wget https://raw.githubusercontent.com/Ascend/tools/master/make_ubuntu_sd.sh > /dev/null 2>&1;\
    wget https://raw.githubusercontent.com/Ascend/tools/master/make_sd_card.py > /dev/null 2>&1
